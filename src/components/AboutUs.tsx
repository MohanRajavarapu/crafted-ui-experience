...
const AboutUs = () => {
  ...
  return <section id="about" className="py-8 md:py-10 lg:py-12 px-6 md:px-16 lg:px-24 bg-card/20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-10 space-y-3">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight">
            About 360 VortexAI<span className="text-gradient">360 VortexAI</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          return <div key={index} className="group p-6 md:p-8 bg-card border border-border/50 rounded-xl hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10">
